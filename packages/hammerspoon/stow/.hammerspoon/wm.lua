...
---     wm.setup({
---         mapping = {
---             saveDesktop    = { { "cmd", "ctrl" }, "s" },
---             restoreDesktop = { { "cmd", "ctrl" }, "r" },
---         },
---     })
---
...
--- Supported mappings:
---
---  * `saveDesktop`    - Save the current desktop arrangement.
---  * `restoreDesktop` - Restore currently-open windows.
---
...
function M.bindHotkeys(mapping)
	...
	if mapping.saveDesktop then
		hs.hotkey.bind(mapping.saveDesktop[1], mapping.saveDesktop[2], M.saveDesktop)
	end

	if mapping.restoreDesktop then
		hs.hotkey.bind(mapping.restoreDesktop[1], mapping.restoreDesktop[2], M.restoreDesktop)
	end
end
